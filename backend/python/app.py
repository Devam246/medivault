...
CANNED_RAG_ANSWERS = {
    "is this sugar level safe": (
        "I cannot diagnose, but generally a fasting blood sugar under 100 mg/dL "
        "and a post-meal level below 140 mg/dL are considered within a safe range. "
        "Please check your exact readings with your clinician and ask them to review your values in the context of your medical history."
    ),
    "methods to control blood pressure": (
        "Common methods to help control blood pressure include reducing salt intake, eating a balanced diet, maintaining a healthy weight, exercising regularly, limiting alcohol, managing stress, and following your prescribed medications. "
        "Discuss specific treatment and lifestyle plans with your doctor before making any changes."
    ),
}
